...
public class TileEntityWrappedInfInv extends TileEntityWrapper implements IInventoryProvider, ISidedInventory
{
	public TileEntityWrappedInfInv()
	{
		super(new TileInfInv());
	}
